...
function formatPosted(value){const d=new Date(value);if(Number.isNaN(d.getTime()))return 'Date not listed';return d.toLocaleDateString(undefined,{day:'numeric',month:'long',year:'numeric'});} days ago`;return d.toLocaleDateString(undefined,{month:'short',day:'numeric'});}
